...
<html>
    ...
    <body>
        ...
        <main class="container">
                            ...
                            <c:if test="${requestScope.list != null}">
                                ...
                                <c:forEach items="${requestScope.list}" var="h">
                                    <tr>
                                        ...
                                        <td>${h.soLuong}</td>
                                        <td>
                                            <fmt:formatNumber value="${h.giaTien}" type="currency" currencySymbol="VND"/>
                                        </td>
                                        <td>
                                            <fmt:formatNumber value="${h.thanhTien}" type="currency" currencySymbol="VND"/>
                                        </td>
                                        <td>${h.isPay == true ? "Đã Thanh Toán":"Chưa Thanh Toán"}</td>
                                    </tr>
                                </c:forEach>
                            </c:if>
            ...
            <c:if test="${sessionScope.user.idUser ne null && requestScope.list != null && requestScope.status != true}">
                <div class="row">
