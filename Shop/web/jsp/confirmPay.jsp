    ...
    <body>
        ...
        <main class="container">
            <div class="row" style="margin-top: 5px; margin-bottom: 5px">
                <h4>Xác thực thanh toán cho người dùng ${sessionScope.user.tenUser}</h4>
            </div>
            <div class="row">
                            ...
                            <c:if test="${requestScope.list != null}">
                                ...
                                <c:forEach items="${requestScope.list}" var="h">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="6">
                                            <fmt:formatNumber value="${requestScope.sum}" type="currency" currencySymbol="VND"/>
            ...
            <div class="row">
                <img style="width: 250px;height: 450px" src="./lib/img/ae1522b9-d748-4807-9605-80edd4d3d31c.jpg" alt="alt"/>
                <form action="ConfirmPay" method="POST">
                    <input name="pay" value="1" hidden=""/>
                    <input name="uid" value="${sessionScope.user.idUser}" hidden=""/>
                    <button type="submit" class="btn btn-outline-success">Xác Thực Đã Thanh Toán</button>
                </form>
                    <a href="ListCard?uid=${sessionScope.user.idUser}">
